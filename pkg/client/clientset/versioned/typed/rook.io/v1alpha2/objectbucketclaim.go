...
type ObjectBucketClaimInterface interface {
	Create(*v1alpha2.ObjectBucketClaim) (*v1alpha2.ObjectBucketClaim, error)
	Update(*v1alpha2.ObjectBucketClaim) (*v1alpha2.ObjectBucketClaim, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha2.ObjectBucketClaim, error)
	List(opts v1.ListOptions) (*v1alpha2.ObjectBucketClaimList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ObjectBucketClaim, err error)
...
func newObjectBucketClaims(c *RookV1alpha2Client, namespace string) *objectBucketClaims {
...
func (c *objectBucketClaims) Get(name string, options v1.GetOptions) (result *v1alpha2.ObjectBucketClaim, err error) {
	result = &v1alpha2.ObjectBucketClaim{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *objectBucketClaims) List(opts v1.ListOptions) (result *v1alpha2.ObjectBucketClaimList, err error) {
	result = &v1alpha2.ObjectBucketClaimList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("objectbucketclaims").
...
func (c *objectBucketClaims) Create(objectBucketClaim *v1alpha2.ObjectBucketClaim) (result *v1alpha2.ObjectBucketClaim, err error) {
	result = &v1alpha2.ObjectBucketClaim{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("objectbucketclaims").
...
func (c *objectBucketClaims) Update(objectBucketClaim *v1alpha2.ObjectBucketClaim) (result *v1alpha2.ObjectBucketClaim, err error) {
	result = &v1alpha2.ObjectBucketClaim{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("objectbucketclaims").
...
func (c *objectBucketClaims) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.ObjectBucketClaim, err error) {
	result = &v1alpha2.ObjectBucketClaim{}
